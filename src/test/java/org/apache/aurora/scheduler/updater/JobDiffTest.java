...
public class JobDiffTest extends EasyMockTest {
  ...
  private static final Set<Range> CANARY_SCOPE = ImmutableSet.of(IRange.build(new Range(0, 0)));
  ...
  private static IAssignedTask instance(TaskConfig config, int instance) {
